...
public enum ThreadsRequestProperty {
    ...
    public static String createFollowerRequestUri(String userId) {
        return THREADS_FRIENDSHIP_REQUEST_URL.getProperty()+ userId+FOLLOWER.getProperty();
    }

    public static String createFollowerNextPageRequestUri(String userId, String nextMaxId) {
        return THREADS_FRIENDSHIP_REQUEST_URL.getProperty()+ userId+FOLLOWER.getProperty()+NEXT_MAX_ID.getProperty()+nextMaxId;
    }

    public static String createFollowingRequestUri(String userId) {
        return THREADS_FRIENDSHIP_REQUEST_URL.getProperty()+ userId+FOLLOWING.getProperty();
    }
